...
class PacketHandler {
    ...
    onCompleted(protocol) {
        this.handler = {
            ...
            41: this.onKeyW2.bind(this),
            42: this.onKeyV.bind(this),
            43: this.onKeyN.bind(this),
            99: this.onChat.bind(this),
            15: this.onKeyW3.bind(this),
            253: this.onKeyW4.bind(this),
            252: this.onKeyW5.bind(this),
            14: this.onKeyW6.bind(this),
    ...
    onKeyW2(message) {
       if (message.length === 1) this.pressW2 = true;
    }
    onKeyW3(message) {
       if (message.length === 1) this.pressW3 = true;
    }
    onKeyW4(message) {
       if (message.length === 1) this.pressW4 = true;
     }
    onKeyW5(message) {
       if (message.length === 1) this.pressW5 = true;
     }
    onKeyW6(message) {
       if (message.length === 1) this.pressW6 = true;
     }
    onKeyE(message) {
    ...
    process() {
       ...
       if (this.pressW2) {
           this.socket.playerTracker.pressW2();
           this.pressW2 = false;
       }
       if (this.pressW3) {
           this.socket.playerTracker.pressW3();
           this.pressW3 = false;
       }
       if (this.pressW4) {
           this.socket.playerTracker.pressW4();
           this.pressW4 = false;
       }
       if (this.pressW5) {
           this.socket.playerTracker.pressW5();
           this.pressW5 = false;
       }
       if (this.pressW6) {
           this.socket.playerTracker.pressW6();
           this.pressW6 = false;
       }
        if (this.pressQ) {
